...
function DropCubes(props) {
  ...
  let getDropCubes = () => {
    ...
    axios.post("https://techdrop-node.herokuapp.com/drop/drops", DropId).then(
      (response) => {
      ...
      <div className="card-body">
        <div className="form-group">
          ...
          <Typography variant="body2" color="textSecondary" component="p">
            ...
            {tokenList.MinimumBid / 10 ** 18} WETH
          </Typography>
          <Typography
            variant="h6"
            gutterBottom
            ...
            {new Date() < new Date(tokenList.AuctionStartsAt) ? (
              <Typography variant="h5" gutterBottom color="textSecondary">
                ...
                <span style={{ color: "#00FF00" }}>
                  <Countdown
                    daysInHours
                    date={new Date(tokenList.AuctionStartsAt)}
                  ></Countdown>
                </span>
              </Typography>
            ) : new Date() > new Date(tokenList.AuctionStartsAt) &&
              new Date() < new Date(tokenList.AuctionEndsAt) ? (
              <Typography
                variant="h5"
                gutterBottom
                color="textSecondary"
              ...
              >
                ...
                <span style={{ color: "#FF0000" }}>
                  <Countdown
                    daysInHours
                    date={new Date(tokenList.AuctionEndsAt)}
                  ></Countdown>
                </span>
              </Typography>
            ) : (
                        ...
                        >
                          <div class="wrapper">
                            <div class="cube-box">
                              ...
                              {new Array(6 - imageData[index].length)
                                .fill(0)
                                .map((_, index) => (
                                  <img src={r1} alt="" />
                                ))}
