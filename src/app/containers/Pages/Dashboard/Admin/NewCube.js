...
function NewCube(props) {
  ...
  let getMyNFTs = () => {
    axios.get("https://techdrop-node.herokuapp.com/nft/createnft").then(
      (response) => {
        console.log("response", response);
          ...
          ipfs.add(Buffer(reader.result), async (err, result) => {
            ...
            await myContractInstance.methods
              ...
              .on("receipt", (receipt) => {
                ...
                axios
                  .post(
                    "https://techdrop-node.herokuapp.com/token/TokenIds",
                    cubeData
                  )
                  .then(
                    (response) => {
                      ...
                      setSalePrice();
                      let variant = "success";
                      enqueueSnackbar("Cube Created Successfully.", {
                        variant,
                      });
                    },
                    (error) => {
                ...
                axios
                  .post(
                    "https://techdrop-node.herokuapp.com/transaction/tokenTransaction ",
                    TrasactionData
                  )
                  .then(
                    (response) => {
                  ...
                  <FormControl component="fieldset">
                    ...
                    >
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="New Artist"
                        onChange={() => setArtistType("New")}
                        checked={artistType === "New"}
                      ...
                      <FormControlLabel
                        ...
                        onChange={() => setArtistType("Existing")}
                        checked={artistType === "Existing"}
                        control={<Radio color="secondary" />}
            ...
            <div className="App">
              <div class="wrapper">
                <div class="cube-box1">
                  ...
                  {new Array(6 - selectedNFTList.length)
                    .fill(0)
                    .map((_, index) => (
                      <img src={r1} alt="" />
                    ))}
