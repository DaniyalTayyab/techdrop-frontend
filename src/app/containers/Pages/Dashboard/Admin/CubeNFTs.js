...
function CubeNFTs(props) {
  ...
  let getCubeNFTs = () => {
    ...
    axios
      .post("https://techdrop-node.herokuapp.com/token/SingleTokenId", Data)
      .then(
        async (response) => {
          ...
          axios
            .get(
              `https://techdrop-node.herokuapp.com/transaction/tokenTransaction/${response.data.tokensdata.tokenId}`
            )
            .then(
              (res) => {
                console.log("res", res);
          ...
          axios
            .post(
              `https://techdrop-node.herokuapp.com/dropcubehistory/history`,
              bidData
            )
            .then(
              (res) => {
  ...
  let claimFunds = async (e) => {
    ...
    if (network !== "ropsten") {
      ...
      axios
        .post(
          `https://techdrop-node.herokuapp.com/adminclaimfunds/claimfunds`,
          Data
        )
        .then(
          (res) => {
  ...
  let getClaimFunds = async () => {
    ...
    axios
      .post(
        `https://techdrop-node.herokuapp.com/adminclaimfunds/getclaimfunds`,
        Data
      )
      .then(
        (res) => {
      ...
      <div className="card-body">
        <form>
                ...
                <div className="row">
                  ...
                  {dropId !== "notdrop" ? (
                    <div className="col-md-12 col-lg-6">
                      ...
                      <h2>
                        Minimum Bid : {dropData.MinimumBid / 10 ** 18} WETH{" "}
                      </h2>
          ...
          <div
            ...
            style={{ marginTop: "20px", marginBottom: "20ox" }}
          >
            <div className="row">
              <div className="col-md-12 col-lg-6">
                <Grid
