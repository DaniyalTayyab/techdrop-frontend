...
function NewNFT(props) {
  ...
  let [rarities, setRarities] = useState([
    "Mastercraft",
    "Legendary",
    "Epic",
    "Rare",
  ...
  let getProfileData = () => {
    axios.get("https://techdrop-node.herokuapp.com/profile/createprofile").then(
      (response) => {
  ...
  let getCollections = () => {
    axios
      .get("https://techdrop-node.herokuapp.com/collection/collections")
      .then(
        (response) => {
          console.log("response", response);
  ...
  const handleAddClick = () => {
    if (image === r1) {
      ...
      console.log("Else k andar token list: ", tokenList);
      ...
      console.log("This is token list data: ", tokenList);
      setIpfsHash("");
      setImage(r1);
      setName("");
      setDescription("");
  ...
  const handleSubmitEvent = async (event) => {
    console.log(
      "Handle submit k start may token list ki length: ",
      tokenList.length,
      "Token list ka data: ",
      tokenList
    );
      ...
      if (network !== "ropsten") {
        ...
        await myContractInstance.methods
          ...
          .on("receipt", (receipt) => {
            ...
            axios
              .post("https://techdrop-node.herokuapp.com/nft/createnft", Data)
              .then(
                (response) => {
                  console.log("response", response);
                  let variant = "success";
  ...
  let onChangeFile = (e) => {
    ...
    axios
      .post("https://techdrop-node.herokuapp.com/upload/uploadtos3", fileData)
      .then(
        (response) => {
            ...
            <form>
              <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <FormControl component="fieldset">
                    <lable component="legend">
                      Select to add Image Artist{" "}
                    </lable>
                    <RadioGroup
                      row
                      aria-label="position"
                    ...
                    >
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="New Image Artist"
                        onChange={() => setImageArtistType("New")}
                        checked={imageArtistType === "New"}
                        control={<Radio color="secondary" />}
                        label="New Image Artist"
                      />
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="Existing Image Artist"
                        onChange={() => setImageArtistType("Existing")}
                        checked={imageArtistType === "Existing"}
                        control={<Radio color="secondary" />}
                        label="Existing Image Artist"
                      />
                    </RadioGroup>
                  </FormControl>
                  {imageArtistType === "New" ? (
                  ...
                  <FormControl component="fieldset">
                    ...
                    >
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="New Producer"
                        onChange={() => setProducerType("New")}
                        checked={producerType === "New"}
                        control={<Radio color="secondary" />}
                        label="New Producer"
                      />
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="Existing Producer"
                        onChange={() => setProducerType("Existing")}
                        checked={producerType === "Existing"}
                        control={<Radio color="secondary" />}
                  ...
                  <FormControl component="fieldset">
                    <lable component="legend">
                      Select to add Executive Producer{" "}
                    </lable>
                    <RadioGroup
                      row
                      aria-label="position"
                    ...
                    >
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="New Executive Producer"
                        onChange={() => setExecutiveProducerType("New")}
                        checked={executiveProducerType === "New"}
                        control={<Radio color="secondary" />}
                        label="New Executive Producer"
                      />
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="Existing Executive Producer"
                        onChange={() => setExecutiveProducerType("Existing")}
                        checked={executiveProducerType === "Existing"}
                        control={<Radio color="secondary" />}
                        label="Existing Executive Producer"
                      />
                    </RadioGroup>
                  </FormControl>
                  ...
                  <FormControl component="fieldset">
                    ...
                    >
                      ...
                      <FormControlLabel
                        style={{ color: "black" }}
                        value="Existing Fan"
                        onChange={() => setFanType("Existing")}
                        checked={fanType === "Existing"}
                        control={<Radio color="secondary" />}
                        label="Existing Fan"
                      />
                    </RadioGroup>
                  ...
                  <FormControl component="fieldset">
                    ...
                    >
                      <FormControlLabel
                        ...
                        onChange={() => setCollectionType("New")}
                      ...
                      <FormControlLabel
                        ...
                        onChange={() => setCollectionType("Existing")}
